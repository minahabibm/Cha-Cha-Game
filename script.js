...
var image = {
  defaul: "default.gif",
  cla: "clap.gif",
  toTheLef: "toTheLeft.gif",
  toTheRig: "toTheRight.gif",
  leftFootSto: "leftFootStomp.gif",
  rightFootSto: "rightFootStomp.gif",
  slideToTheLe: "slideToTheLeft.gif",
  slideToTheRi: "slideToTheRight.gif",
  toTheBac:"toTheBack.gif",
  toTheTo:"toTheTop.gif",
  toTheFlo:"totheFloor.gif",
  handsOnKne:"handsOnYourKnees.gif",
  crissCros:"crissCross.gif",
  revers:"reverse.gif",
  charlieBrow:"charlieBrown.gif",
  chaCh:"chaCha.gif",
  hopp:"hop.gif",
  turnAroun: "turnAround.gif",
};
var myGamePiece;
var myGameArea = {
